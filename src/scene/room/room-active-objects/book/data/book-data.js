...
const OPEN_BOOK_WITHOUT_ACTIVE_PAGES_PARTS = [
  BOOK_PART_TYPE.BookLeftCover,
  BOOK_PART_TYPE.BookLeftPages,
  BOOK_PART_TYPE.BookLeftTopPage,
  BOOK_PART_TYPE.BookRightCover,
...
const OPEN_BOOK_WITHOUT_ALL_PAGES_PARTS = [
  BOOK_PART_TYPE.BookLeftCover,
  BOOK_PART_TYPE.BookLeftPages,
  BOOK_PART_TYPE.BookRightCover,
  BOOK_PART_TYPE.BookRightPages,
...
export {
  ...
  OPEN_BOOK_WITHOUT_ACTIVE_PAGES_PARTS,
  OPEN_BOOK_WITHOUT_ALL_PAGES_PARTS,
  BOOK_SIDE,
  PAGE_SIDE,
  PAGE_MATERIAL_TYPE,
  PAGE_FLIP_DIRECTION,
